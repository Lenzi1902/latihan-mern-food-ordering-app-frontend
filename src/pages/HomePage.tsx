  ...
  return (
    <div className="flex flex-col gap-12">
      <div className="md:px-32 bg-white rounded-lg shadow-md py-8 flex flex-col text-center gap-5 -mt-16">
        <h1 className="text-5xl font-bold tracking-tight text-orange-600">Tuck into a takway today</h1>
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col items-center justify-center gap-4 text-center">
          ...
          <span>Download the MernEats App for faster ordering and peronalised recommendations</span>
