...
type CheckoutSessionRequest = {
  cartItems: {
    ...
    name: string;
    quantity: string;
  }[]; // jadi intinya ketika mneggunakan array setelah cartItems itu, type itu mengharapkan cartitems itu dia adalah array, jadi data yang ada di dalam cartitems itu berupa object, tapi cartItems itu sebagai induk adlaah array: [{},{}], jadi bisa menampung banyak data di satu type
  deliveryDetails: {
    email: string;
    name: string;
    addressLine1: string;
